...
RD_LO = np.array([13,24,228])
RD_HI = np.array([255,255,255])
RB_LO = np.array([153,125,0])
RB_HI = np.array([193,208,255])
    ...
    def run(self):
        ...
        while True:
            ...
            if ret:
                ...
                # proses start
                if startx >=  NODE_A[0]-D and startx <=  NODE_A[0]+D and starty >=  NODE_A[1]-E and starty <=  NODE_A[1]+E:
                    start = 'A1'
                if startx >=  NODE_A[2]-D and startx <=  NODE_A[2]+D and starty >=  NODE_A[3]-E and starty <=  NODE_A[3]+E:
                    start = 'A2'
                if startx >=  NODE_A[4]-D and startx <=  NODE_A[4]+D and starty >=  NODE_A[5]-E and starty <=  NODE_A[5]+E:
                    start = 'A3'
                if startx >=  NODE_A[6]-D and startx <=  NODE_A[6]+D and starty >=  NODE_A[7]-E and starty <=  NODE_A[7]+E:
                    start = 'A4'
                if startx >=  NODE_A[8]-D and startx <=  NODE_A[8]+D and starty >=  NODE_A[9]-E and starty <=  NODE_A[9]+E:
                    start = 'A5'
                if startx >=  NODE_B[0]-D and startx <=  NODE_B[0]+D and starty >=  NODE_B[1]-E and starty <=  NODE_B[1]+E:
                    start = 'B1'
                if startx >=  NODE_B[2]-D and startx <=  NODE_B[2]+D and starty >=  NODE_B[3]-E and starty <=  NODE_B[3]+E:
                    start = 'B2'
                if startx >=  NODE_B[4]-D and startx <=  NODE_B[4]+D and starty >=  NODE_B[5]-E and starty <=  NODE_B[5]+E:
                    start = 'B3'
                if startx >=  NODE_B[6]-D and startx <=  NODE_B[6]+D and starty >=  NODE_B[7]-E and starty <=  NODE_B[7]+E:
                    start = 'B4'
                if startx >=  NODE_B[8]-D and startx <=  NODE_B[8]+D and starty >=  NODE_B[9]-E and starty <=  NODE_B[9]+E:
                    start = 'B5'
                if startx >=  NODE_C[0]-D and startx <=  NODE_C[0]+D and starty >=  NODE_C[1]-E and starty <=  NODE_C[1]+E:
                    start = 'C1'
                if startx >=  NODE_C[2]-D and startx <=  NODE_C[2]+D and starty >=  NODE_C[3]-E and starty <=  NODE_C[3]+E:
                    start = 'C2'
                if startx >=  NODE_C[4]-D and startx <=  NODE_C[4]+D and starty >=  NODE_C[5]-E and starty <=  NODE_C[5]+E:
                    start = 'C3'
                if startx >=  NODE_C[6]-D and startx <=  NODE_C[6]+D and starty >=  NODE_C[7]-E and starty <=  NODE_C[7]+E:
                    start = 'C4'
                if startx >=  NODE_C[8]-D and startx <=  NODE_C[8]+D and starty >=  NODE_C[9]-E and starty <=  NODE_C[9]+E:
                    start = 'C5'
                if startx >=  NODE_D[0]-D and startx <=  NODE_D[0]+D and starty >=  NODE_D[1]-E and starty <=  NODE_D[1]+E:
                    start = 'D1'
                if startx >=  NODE_D[2]-D and startx <=  NODE_D[2]+D and starty >=  NODE_D[3]-E and starty <=  NODE_D[3]+E:
                    start = 'D2'
                if startx >=  NODE_D[4]-D and startx <=  NODE_D[4]+D and starty >=  NODE_D[5]-E and starty <=  NODE_D[5]+E:
                    start = 'D3'
                if startx >=  NODE_D[6]-D and startx <=  NODE_D[6]+D and starty >=  NODE_D[7]-E and starty <=  NODE_D[7]+E:
                    start = 'D4'
                if startx >=  NODE_D[8]-D and startx <=  NODE_D[8]+D and starty >=  NODE_D[9]-E and starty <=  NODE_D[9]+E:
                    start = 'D5'
                if startx >=  NODE_E[0]-D and startx <=  NODE_E[0]+D and starty >=  NODE_E[1]-E and starty <=  NODE_E[1]+E:
                    start = 'E1'
                if startx >=  NODE_E[2]-D and startx <=  NODE_E[2]+D and starty >=  NODE_E[3]-E and starty <=  NODE_E[3]+E:
                    start = 'E2'
                if startx >=  NODE_E[4]-D and startx <=  NODE_E[4]+D and starty >=  NODE_E[5]-E and starty <=  NODE_E[5]+E:
                    start = 'E3'
                if startx >=  NODE_E[6]-D and startx <=  NODE_E[6]+D and starty >=  NODE_E[7]-E and starty <=  NODE_E[7]+E:
                    start = 'E4'
                if startx >=  NODE_E[8]-D and startx <=  NODE_E[8]+D and starty >=  NODE_E[9]-E and starty <=  NODE_E[9]+E:
                    start = 'E5'
                if startx >=  NODE_F[0]-D and startx <=  NODE_F[0]+D and starty >=  NODE_F[1]-E and starty <=  NODE_F[1]+E:
                    start = 'F1'
                if startx >=  NODE_F[2]-D and startx <=  NODE_F[2]+D and starty >=  NODE_F[3]-E and starty <=  NODE_F[3]+E:
                    start = 'F2'
                if startx >=  NODE_F[4]-D and startx <=  NODE_F[4]+D and starty >=  NODE_F[5]-E and starty <=  NODE_F[5]+E:
                    start = 'F3'
                if startx >=  NODE_F[6]-D and startx <=  NODE_F[6]+D and starty >=  NODE_F[7]-E and starty <=  NODE_F[7]+E:
                    start = 'F4'
                if startx >=  NODE_F[8]-D and startx <=  NODE_F[8]+D and starty >=  NODE_F[9]-E and starty <=  NODE_F[9]+E:
                    start = 'F5'
                if startx >=  NODE_G[0]-D and startx <=  NODE_G[0]+D and starty >=  NODE_G[1]-E and starty <=  NODE_G[1]+E:
                    start = 'G1'
                if startx >=  NODE_G[2]-D and startx <=  NODE_G[2]+D and starty >=  NODE_G[3]-E and starty <=  NODE_G[3]+E:
                    start = 'G2'
                if startx >=  NODE_G[4]-D and startx <=  NODE_G[4]+D and starty >=  NODE_G[5]-E and starty <=  NODE_G[5]+E:
                    start = 'G3'
                if startx >=  NODE_G[6]-D and startx <=  NODE_G[6]+D and starty >=  NODE_G[7]-E and starty <=  NODE_G[7]+E:
                    start = 'G4'
                if startx >=  NODE_G[8]-D and startx <=  NODE_G[8]+D and starty >=  NODE_G[9]-E and starty <=  NODE_G[9]+E:
                    start = 'G5'
                if startx >=  NODE_H[0]-D and startx <=  NODE_H[0]+D and starty >=  NODE_H[1]-E and starty <=  NODE_H[1]+E:
                    start = 'H1'
                if startx >=  NODE_H[2]-D and startx <=  NODE_H[2]+D and starty >=  NODE_H[3]-E and starty <=  NODE_H[3]+E:
                    start = 'H2'
                if startx >=  NODE_H[4]-D and startx <=  NODE_H[4]+D and starty >=  NODE_H[5]-E and starty <=  NODE_H[5]+E:
                    start = 'H3'
                if startx >=  NODE_H[6]-D and startx <=  NODE_H[6]+D and starty >=  NODE_H[7]-E and starty <=  NODE_H[7]+E:
                    start = 'H4'
                if startx >=  NODE_H[8]-D and startx <=  NODE_H[8]+D and starty >=  NODE_H[9]-E and starty <=  NODE_H[9]+E:
                    start = 'H5'
                if startx >=  NODE_I[0]-D and startx <=  NODE_I[0]+D and starty >=  NODE_I[1]-E and starty <=  NODE_I[1]+E:
                    start = 'I1'
                if startx >=  NODE_I[2]-D and startx <=  NODE_I[2]+D and starty >=  NODE_I[3]-E and starty <=  NODE_I[3]+E:
                    start = 'I2'
                if startx >=  NODE_I[4]-D and startx <=  NODE_I[4]+D and starty >=  NODE_I[5]-E and starty <=  NODE_I[5]+E:
                    start = 'I3'
                if startx >=  NODE_I[6]-D and startx <=  NODE_I[6]+D and starty >=  NODE_I[7]-E and starty <=  NODE_I[7]+E:
                    start = 'I4'
                if startx >=  NODE_I[8]-D and startx <=  NODE_I[8]+D and starty >=  NODE_I[9]-E and starty <=  NODE_I[9]+E:
                    start = 'I5'
                if startx >=  NODE_J[0]-D and startx <=  NODE_J[0]+D and starty >=  NODE_J[1]-E and starty <=  NODE_J[1]+E:
                    start = 'J1'
                if startx >=  NODE_J[2]-D and startx <=  NODE_J[2]+D and starty >=  NODE_J[3]-E and starty <=  NODE_J[3]+E:
                    start = 'J2'
                if startx >=  NODE_J[4]-D and startx <=  NODE_J[4]+D and starty >=  NODE_J[5]-E and starty <=  NODE_J[5]+E:
                    start = 'J3'
                if startx >=  NODE_J[6]-D and startx <=  NODE_J[6]+D and starty >=  NODE_J[7]-E and starty <=  NODE_J[7]+E:
                    start = 'J4'
                if startx >=  NODE_J[8]-D and startx <=  NODE_J[8]+D and starty >=  NODE_J[9]-E and starty <=  NODE_J[9]+E:
                    start = 'J5'
                #print('start', start)
                ...
                # goal proses
                if goalx >=  NODE_A[0]-D and goalx <=  NODE_A[0]+D and goaly >=  NODE_A[1]-E and goaly <=  NODE_A[1]+E:
                    goal = 'A1'
                if goalx >=  NODE_A[2]-D and goalx <=  NODE_A[2]+D and goaly >=  NODE_A[3]-E and goaly <=  NODE_A[3]+E:
                    goal = 'A2'
                if goalx >=  NODE_A[4]-D and goalx <=  NODE_A[4]+D and goaly >=  NODE_A[5]-E and goaly <=  NODE_A[5]+E:
                    goal = 'A3'
                if goalx >=  NODE_A[6]-D and goalx <=  NODE_A[6]+D and goaly >=  NODE_A[7]-E and goaly <=  NODE_A[7]+E:
                    goal = 'A4'
                if goalx >=  NODE_A[8]-D and goalx <=  NODE_A[8]+D and goaly >=  NODE_A[9]-E and goaly <=  NODE_A[9]+E:
                    goal = 'A5'
                if goalx >=  NODE_B[0]-D and goalx <=  NODE_B[0]+D and goaly >=  NODE_B[1]-E and goaly <=  NODE_B[1]+E:
                    goal = 'B1'
                if goalx >=  NODE_B[2]-D and goalx <=  NODE_B[2]+D and goaly >=  NODE_B[3]-E and goaly <=  NODE_B[3]+E:
                    goal = 'B2'
                if goalx >=  NODE_B[4]-D and goalx <=  NODE_B[4]+D and goaly >=  NODE_B[5]-E and goaly <=  NODE_B[5]+E:
                    goal = 'B3'
                if goalx >=  NODE_B[6]-D and goalx <=  NODE_B[6]+D and goaly >=  NODE_B[7]-E and goaly <=  NODE_B[7]+E:
                    goal = 'B4'
                if goalx >=  NODE_B[8]-D and goalx <=  NODE_B[8]+D and goaly >=  NODE_B[9]-E and goaly <=  NODE_B[9]+E:
                    goal = 'B5'
                if goalx >=  NODE_C[0]-D and goalx <=  NODE_C[0]+D and goaly >=  NODE_C[1]-E and goaly <=  NODE_C[1]+E:
                    goal = 'C1'
                if goalx >=  NODE_C[2]-D and goalx <=  NODE_C[2]+D and goaly >=  NODE_C[3]-E and goaly <=  NODE_C[3]+E:
                    goal = 'C2'
                if goalx >=  NODE_C[4]-D and goalx <=  NODE_C[4]+D and goaly >=  NODE_C[5]-E and goaly <=  NODE_C[5]+E:
                    goal = 'C3'
                if goalx >=  NODE_C[6]-D and goalx <=  NODE_C[6]+D and goaly >=  NODE_C[7]-E and goaly <=  NODE_C[7]+E:
                    goal = 'C4'
                if goalx >=  NODE_C[8]-D and goalx <=  NODE_C[8]+D and goaly >=  NODE_C[9]-E and goaly <=  NODE_C[9]+E:
                    goal = 'C5'
                if goalx >=  NODE_D[0]-D and goalx <=  NODE_D[0]+D and goaly >=  NODE_D[1]-E and goaly <=  NODE_D[1]+E:
                    goal = 'D1'
                if goalx >=  NODE_D[2]-D and goalx <=  NODE_D[2]+D and goaly >=  NODE_D[3]-E and goaly <=  NODE_D[3]+E:
                    goal = 'D2'
                if goalx >=  NODE_D[4]-D and goalx <=  NODE_D[4]+D and goaly >=  NODE_D[5]-E and goaly <=  NODE_D[5]+E:
                    goal = 'D3'
                if goalx >=  NODE_D[6]-D and goalx <=  NODE_D[6]+D and goaly >=  NODE_D[7]-E and goaly <=  NODE_D[7]+E:
                    goal = 'D4'
                if goalx >=  NODE_D[8]-D and goalx <=  NODE_D[8]+D and goaly >=  NODE_D[9]-E and goaly <=  NODE_D[9]+E:
                    goal = 'D5'
                if goalx >=  NODE_E[0]-D and goalx <=  NODE_E[0]+D and goaly >=  NODE_E[1]-E and goaly <=  NODE_E[1]+E:
                    goal = 'E1'
                if goalx >=  NODE_E[2]-D and goalx <=  NODE_E[2]+D and goaly >=  NODE_E[3]-E and goaly <=  NODE_E[3]+E:
                    goal = 'E2'
                if goalx >=  NODE_E[4]-D and goalx <=  NODE_E[4]+D and goaly >=  NODE_E[5]-E and goaly <=  NODE_E[5]+E:
                    goal = 'E3'
                if goalx >=  NODE_E[6]-D and goalx <=  NODE_E[6]+D and goaly >=  NODE_E[7]-E and goaly <=  NODE_E[7]+E:
                    goal = 'E4'
                if goalx >=  NODE_E[8]-D and goalx <=  NODE_E[8]+D and goaly >=  NODE_E[9]-E and goaly <=  NODE_E[9]+E:
                    goal = 'E5'
                if goalx >=  NODE_F[0]-D and goalx <=  NODE_F[0]+D and goaly >=  NODE_F[1]-E and goaly <=  NODE_F[1]+E:
                    goal = 'F1'
                if goalx >=  NODE_F[2]-D and goalx <=  NODE_F[2]+D and goaly >=  NODE_F[3]-E and goaly <=  NODE_F[3]+E:
                    goal = 'F2'
                if goalx >=  NODE_F[4]-D and goalx <=  NODE_F[4]+D and goaly >=  NODE_F[5]-E and goaly <=  NODE_F[5]+E:
                    goal = 'F3'
                if goalx >=  NODE_F[6]-D and goalx <=  NODE_F[6]+D and goaly >=  NODE_F[7]-E and goaly <=  NODE_F[7]+E:
                    goal = 'F4'
                if goalx >=  NODE_F[8]-D and goalx <=  NODE_F[8]+D and goaly >=  NODE_F[9]-E and goaly <=  NODE_F[9]+E:
                    goal = 'F5'
                if goalx >=  NODE_G[0]-D and goalx <=  NODE_G[0]+D and goaly >=  NODE_G[1]-E and goaly <=  NODE_G[1]+E:
                    goal = 'G1'
                if goalx >=  NODE_G[2]-D and goalx <=  NODE_G[2]+D and goaly >=  NODE_G[3]-E and goaly <=  NODE_G[3]+E:
                    goal = 'G2'
                if goalx >=  NODE_G[4]-D and goalx <=  NODE_G[4]+D and goaly >=  NODE_G[5]-E and goaly <=  NODE_G[5]+E:
                    goal = 'G3'
                if goalx >=  NODE_G[6]-D and goalx <=  NODE_G[6]+D and goaly >=  NODE_G[7]-E and goaly <=  NODE_G[7]+E:
                    goal = 'G4'
                if goalx >=  NODE_G[8]-D and goalx <=  NODE_G[8]+D and goaly >=  NODE_G[9]-E and goaly <=  NODE_G[9]+E:
                    goal = 'G5'
                if goalx >=  NODE_H[0]-D and goalx <=  NODE_H[0]+D and goaly >=  NODE_H[1]-E and goaly <=  NODE_H[1]+E:
                    goal = 'H1'
                if goalx >=  NODE_H[2]-D and goalx <=  NODE_H[2]+D and goaly >=  NODE_H[3]-E and goaly <=  NODE_H[3]+E:
                    goal = 'H2'
                if goalx >=  NODE_H[4]-D and goalx <=  NODE_H[4]+D and goaly >=  NODE_H[5]-E and goaly <=  NODE_H[5]+E:
                    goal = 'H3'
                if goalx >=  NODE_H[6]-D and goalx <=  NODE_H[6]+D and goaly >=  NODE_H[7]-E and goaly <=  NODE_H[7]+E:
                    goal = 'H4'
                if goalx >=  NODE_H[8]-D and goalx <=  NODE_H[8]+D and goaly >=  NODE_H[9]-E and goaly <=  NODE_H[9]+E:
                    goal = 'H5'
                if goalx >=  NODE_I[0]-D and goalx <=  NODE_I[0]+D and goaly >=  NODE_I[1]-E and goaly <=  NODE_I[1]+E:
                    goal = 'I1'
                if goalx >=  NODE_I[2]-D and goalx <=  NODE_I[2]+D and goaly >=  NODE_I[3]-E and goaly <=  NODE_I[3]+E:
                    goal = 'I2'
                if goalx >=  NODE_I[4]-D and goalx <=  NODE_I[4]+D and goaly >=  NODE_I[5]-E and goaly <=  NODE_I[5]+E:
                    goal = 'I3'
                if goalx >=  NODE_I[6]-D and goalx <=  NODE_I[6]+D and goaly >=  NODE_I[7]-E and goaly <=  NODE_I[7]+E:
                    goal = 'I4'
                if goalx >=  NODE_I[8]-D and goalx <=  NODE_I[8]+D and goaly >=  NODE_I[9]-E and goaly <=  NODE_I[9]+E:
                    goal = 'I5'
                if goalx >=  NODE_J[0]-D and goalx <=  NODE_J[0]+D and goaly >=  NODE_J[1]-E and goaly <=  NODE_J[1]+E:
                    goal = 'J1'
                if goalx >=  NODE_J[2]-D and goalx <=  NODE_J[2]+D and goaly >=  NODE_J[3]-E and goaly <=  NODE_J[3]+E:
                    goal = 'J2'
                if goalx >=  NODE_J[4]-D and goalx <=  NODE_J[4]+D and goaly >=  NODE_J[5]-E and goaly <=  NODE_J[5]+E:
                    goal = 'J3'
                if goalx >=  NODE_J[6]-D and goalx <=  NODE_J[6]+D and goaly >=  NODE_J[7]-E and goaly <=  NODE_J[7]+E:
                    goal = 'J4'
                if goalx >=  NODE_J[8]-D and goalx <=  NODE_J[8]+D and goaly >=  NODE_J[9]-E and goaly <=  NODE_J[9]+E:
                    goal = 'J5'
                #print('goal', goal)
